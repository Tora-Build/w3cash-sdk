 ...
 * @notice Deploy additional adapters to existing W3Cash deployment
 */
contract DeployAdapters is Script {
    // Existing deployment (Base Sepolia)
    ...
    address constant UNISWAP_ROUTER = 0x94cC0AaC535CCDB3C01d6787D6413C739ae12bc4; // Uniswap V3 on Base Sepolia

    // Adapter IDs (continuing from existing: 0=Wait, 1=Query, 2=Aave)
    ...
    function run() external {
        ...
        console.log("Deploying new adapters...");
