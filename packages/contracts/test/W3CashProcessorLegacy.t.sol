...
contract W3CashProcessorLegacyTest is Test {
    using ECDSA for bytes32;

    W3CashProcessorLegacy public processor;
    ...
    function setUp() public {
        ...
        processor = new W3CashProcessorLegacy(address(registry));
    }
    ...
    function test_Constructor_RevertIfZeroRegistry() public {
        ...
        new W3CashProcessorLegacy(address(0));
    }
